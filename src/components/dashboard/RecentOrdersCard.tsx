          ...
          <div className="divide-y divide-slyce-border">
            {orders.map((o) => (
              <div
                ...
                className="flex items-center gap-3 py-2.5 cursor-pointer hover:bg-cream/40 -mx-5 px-5 transition-colors"
              >
                ...
                <span className={`text-[11px] font-medium px-2 py-0.5 rounded-full border ${STATUS_STYLES[o.status as OrderStatus] ?? "bg-gray-50 text-gray-600 border-gray-200"}`}>
